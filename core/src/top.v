module top (
    ...
    // IDU -> EXU
    wire                  id_ex_valid;
    wire [`XLEN-1:0] id_ex_imm, id_ex_rs1_data, id_ex_rs2_data;
    wire [4:0] id_ex_rd;
    ...
    IDU u_IDU (
    .clk(clk),
    .rst(rst),  // Synchronous High Active reset
    ...
    .ex_lsu_valid(ex_lsu_valid),       //To detect 
    ...
    wire [`XLEN-1:0] rf_id_rs1_data, rf_id_rs2_data, wb_rf_data;
    wire wb_rf_wen;
    wire [4:0] wb_rf_rd;
    Regfile u_regfile (
        .clk      (clk),
    ...
    wire ex_lsu_valid, lsu_ex_ready;
    wire [`XLEN-1:0] ex_lsu_addr, ex_lsu_data, ex_lsu_wb_data;
    wire [1:0] ex_lsu_ctrl, ex_lsu_size;
    ...
    wire lsu_cache_valid, lsu_cache_wen, cache_lsu_hit;
    wire [`XLEN-1:0] lsu_cache_addr, lsu_cache_wdata, cache_lsu_rdata;
    ...
    wire lsu_wbu_valid, lsu_wbu_wen;
    ...
    // From Memory stage
    .lsu_wbu_data(lsu_wbu_data),        // Data from memory
    .lsu_wbu_valid(lsu_wbu_valid),
    .lsu_wbu_rd(lsu_wbu_rd),               // Destination register
    .lsu_wbu_wen(lsu_wbu_wen),                  // Write back enable
    
    // Write back interface
    .wb_rf_data(wb_rf_data),    // Data to write
    .wb_rf_rd(wb_rf_rd),       // Destination register
    .wb_rf_wen(wb_rf_wen)         // Write back enable output
);
